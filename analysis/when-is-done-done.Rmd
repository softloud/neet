...
People who have contributed feedback or assisted, some of whom might be co-authors on later drafts: Danielle Navarro, Elise Gould, Hannah Fraser, Aaron 
...
```{r codebrain,echo=FALSE,message=FALSE,fig.height=5,fig.cap="code::brain before coderegistration."}
library(igraph)
...
```{r message=FALSE, fig.width=15, fig.height=5, fig.cap="Codebrain after coderegistration."}
