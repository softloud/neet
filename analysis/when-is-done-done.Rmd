...
## qrps in scientific computing

## coding practice to mitigate anxiety & facillitate collaboration

# what is this manuscript? a toolchain walkthrough
...
The `simeta::` package was developed to test the estimators provided in the `varameta::` package. 
