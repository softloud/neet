...
### On a piece of paper.
  ...
  1. Draw a diagram of the inputs and outputs of a algorithm.
...
If possible, include image of diagram if not burdonsomely time consuming (but this often is).

For those comfortable with *graphs* understood as mathematical objects as a set of vertices from $V$, and a set of edges $V \times V$. There are a few options. 
